        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => ['admin.products.update', $product->slug], 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'files' => true)) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('title') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('title', $product->title, array('id' => 'email', 'class' => 'form-control', 'placeholder' => 'Enter Title')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('tagline') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('tagline', $product->tagline, array('id' => 'tagline', 'class' => 'form-control', 'placeholder' => 'Enter Tagline')) !!}
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('description') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <textarea class="form-control {{ $errors->has('description') ? ' has-error ' : '' }}" name="description" id="description">{{old('description', $product->description)}}</textarea>
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="name">
                                            <i class="fa fa-fw fa-sort-alpha-desc" aria-hidden="true"></i>
                                        </label>
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('specifications') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <textarea class="form-control {{ $errors->has('specifications') ? ' has-error ' : '' }}" name="specifications" id="specifications">{{old('specifications', $product->specifications)}}</textarea>
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="name">
                                            <i class="fa fa-fw fa-sort-alpha-desc" aria-hidden="true"></i>
                                        </label>
                                ...
                                <div class="input-group">
                                    <select class="form-control{{ $errors->has('category') ? ' is-invalid' : '' }}" id="category-select" name="category" required>
                                        ...
                                        @foreach($categories as $category)
                                            <option @if(old('category') == $category->id || $category->id == $product->category_id) selected @endif value="{{$category->id}}" data-slug="{{$category->slug}}">{{$category->title}}</option>
                                        @endforeach
                                    </select>
                                    <div class="input-group-append">
                                        <label for="email" class="input-group-text">
                                ...
                                <div class="input-group">
                                    <select class="form-control{{ $errors->has('sub_category') ? ' is-invalid' : '' }}" id="sub-category-select" name="sub_category">
                                        @if($product->subCategory != null)
                                            <option selected value="{{$product->subCategory->id}}">{{$product->subCategory->title}}</option>
                                        @endif
                                    </select>
                                    <div class="input-group-append">
                                        <label for="email" class="input-group-text">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('image') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <img width="50%" src="{{$product->getFirstMediaUrl('product-images')}}">
                                </div>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlFile1">Product Image (it will replace the old one)</label>

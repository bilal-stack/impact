        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                <a href="{{ route('admin.categories.list') }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="{{ trans('usersmanagement.tooltips.back-users') }}">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => 'admin.categories.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'files' => true)) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('sub_category') ? ' has-error ' : '' }}">
                            <label for="exampleFormControlSelect1" class="col-md-3 control-label">Sub Categories</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <select class="form-control{{ $errors->has('sub_category') ? ' is-invalid' : '' }}" id="category-select" name="sub_category[]" multiple>
                                        @foreach($subCategories as $category)
                                            <option @if(old('sub_category') == $category->slug) selected @endif value="{{$category->id}}" data-slug="{{$category->slug}}">{{$category->title}}</option>
                                        @endforeach
                                    </select>
                                    <div class="input-group-append">
                                        <label for="email" class="input-group-text">

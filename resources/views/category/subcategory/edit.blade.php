...
@section('template_title')
    Edit Sub Category - {{$subCategory->title}}
@endsection
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                <a href="{{ route('admin.sub.categories.list') }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="Back to Sub Categories">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => ['admin.sub.categories.update', $subCategory->slug], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation', 'enctype' => 'multipart/form-data')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('title') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('title', $subCategory->title, array('id' => 'title', 'class' => 'form-control', 'placeholder' => 'Enter Title')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('description') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <textarea class="form-control {{ $errors->has('description') ? ' has-error ' : '' }}" name="description" id="description">{{$subCategory->description}}</textarea>
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('image') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    @foreach($subCategory->getMedia('category-images') as $item)

                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="btn-group pull-right btn-group-xs">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href={{url('variations/create')}}>
                                        <i class="fa fa-fw fa-user-plus" aria-hidden="true"></i>
                                        Create New Variation
                                    </a>
                                    <a class="dropdown-item" href="{{url('variations/sizes/index')}}">
                                        <i class="fa fa-fw fa-user-plus" aria-hidden="true"></i>
                                       Variation Sizes
                                    </a>
                                    <a class="dropdown-item" href="{{url('variations/create')}}">
                            ...
                            <table class="table table-striped table-sm data-table">
                                ...
                                @foreach($variations as $variation)
                                    <tr>
                                        ...
                                        <td><img width="20%" src="{{asset('storage/'. $variation->option_image)}}"></td>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success btn-block" href="{{ URL::to('variations/' . $variation->id) }}" data-toggle="tooltip" title="Show">
                                                View
                                            </a>
                                        </td>
                                        <td>
                                            <a class="btn btn-sm btn-info btn-block" href="{{ route('admin.variations.edit', $variation->id) }}" data-toggle="tooltip" title="Edit">
                                                Edit
                                            </a>
                                        </td>
                                    </tr>

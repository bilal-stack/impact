        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => ['admin.categories.update', $category->slug], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation', 'enctype' => 'multipart/form-data')) !!}

                        {!! csrf_field() !!}

                        <div class="form-group has-feedback row {{ $errors->has('title') ? ' has-error ' : '' }}">
                            {!! Form::label('title', 'Category Title', array('class' => 'col-md-3 control-label')); !!}
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('title', $category->title, array('id' => 'title', 'class' => 'form-control', 'placeholder' => 'Enter Title')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('sub_categories') ? ' has-error ' : '' }}">
                            <label for="exampleFormControlSelect1" class="col-md-3 control-label">Sub Categories</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <select class="form-control{{ $errors->has('sub_categories') ? ' is-invalid' : '' }}" id="category-select" name="sub_categories[]" multiple>
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('tagline') ? ' has-error ' : '' }}">
                            {!! Form::label('tagline', 'Category Tagline', array('class' => 'col-md-3 control-label')); !!}
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('tagline', $category->tagline, array('id' => 'tagline', 'class' => 'form-control', 'placeholder' => 'Enter Tagline')) !!}
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('description') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <textarea class="form-control {{ $errors->has('description') ? ' has-error ' : '' }}" name="description" id="description">{{$category->description}}</textarea>
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="name">
                                            <i class="fa fa-fw fa-sort-alpha-desc" aria-hidden="true"></i>
                                        </label>
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlFile1">Category Image (it will replace the old one)</label>
